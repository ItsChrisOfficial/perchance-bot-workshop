...
| frontier_foundry_1.1 | completed | `bots/completed/frontier_foundry_1.1/` | Phase 1 foundation checkpoint for Chronicle Foundry engine architecture with deterministic state systems and command baseline | active | in-progress | TEMP PASS 1 checkpoint on 2026-04-02; foundation systems validated, Phase 2 to expand simulation depth and iframe operations UI |
