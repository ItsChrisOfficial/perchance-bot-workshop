...
| frontier_foundry_1.2 | completed | `bots/completed/frontier_foundry_1.2/` | Phase 2 usable checkpoint for Chronicle Foundry with real iframe operations UI and stateful simulation actions | active | in-progress | TEMP PASS 2 checkpoint on 2026-04-02; renamed from frontier_foundry_1.1 and expanded into usable multi-screen engine pending final Phase 3 hardening |
